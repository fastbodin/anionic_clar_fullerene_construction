...
def add_cap(cap_type, cap_turn, cap_flip, num_rings):
    ...
    if num_rings == 0:
        ...
        if cap_type == 10:
            prev_r_v = shift_by_turns([-3,-5,-6,-8,-9,-10,-12,-1,-2], cap_turn)
        elif cap_type == 11:
            prev_r_v = shift_by_turns([-13,-1,-2,-4,-6,-7,-8,-10,-11], cap_turn)
        elif cap_type == 12:
            prev_r_v = shift_by_turns([-5,-7,-9,-11,-13,-14,-16,-1,-3], cap_turn)
        elif cap_type == 13:
            prev_r_v = shift_by_turns([-14,-1,-2,-4,-6,-7,-9,-11,-13], cap_turn)
        elif cap_type == 14:
            prev_r_v = shift_by_turns([-14,-1,-2,-4,-6,-7,-9,-11,-13], cap_turn)
        elif cap_type == 15:
            prev_r_v = shift_by_turns([-5,-7,-8,-10,-12,-14,-15,-1,-3], cap_turn)
        elif cap_type == 16:
            prev_r_v = shift_by_turns([-5,-7,-8,-10,-12,-14,-16,-1,-3], cap_turn)
        elif cap_type == 17:
            prev_r_v = shift_by_turns([-5,-7,-8,-10,-12,-14,-16,-1,-3], cap_turn)
        elif cap_type == 18:
            prev_r_v = shift_by_turns([-16,-1,-2,-4,-6,-8,-10,-12,-14], cap_turn)
        else:
            print("bad cap_type")
            exit(0)
    elif num_rings % 3 == 1:
